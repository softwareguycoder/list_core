 ...
 * the data specified.
 * @param ppNewHead Address of a pointer to an instance of POSITION. This
 * variable will receive the address of the head of the linked list.
 * @param ppvData Address of a pointer to the data that the first node
 * should refer to.
